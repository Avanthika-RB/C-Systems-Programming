 ...
 * @return: if successful, a pointer to the new head of the linked list.
 ...
 * @param: head is the pointer to the first node in the linked list
 * @param: key is a string in the (key, value) pair
 * @param: num is the pointer to a variable that indicates if delete happened.
 * The variable should be set to 1 if delete happened, 0 otherwise
...
/*
 * prints the content of the linked list of (key, value) pairs. should print []
